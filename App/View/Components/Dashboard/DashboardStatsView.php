            ...
            <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-black mt-1"><?= $stats['availableItems'] ?></h3>
                    </div>
            ...
            <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-black mt-1"><?= $stats['totalItems'] ?></h3>
                    </div>
                    <div class="w-12 h-12 bg-black/5 rounded-full flex items-center justify-center">
            ...
            <div class="bg-white border border-gray-100 rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-black mt-1"><?= $stats['pendingLoans'] ?></h3>
                    </div>
                    <div class="w-12 h-12 bg-black/5 rounded-full flex items-center justify-center">
